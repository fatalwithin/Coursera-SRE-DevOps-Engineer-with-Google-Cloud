...
After that, we will cover the first two pillars of DevOps; a**ccepting failure as normal** and **reducing organizational silos**, and some of the SRE technical practices and cultural fundamentals that Google aligns to them. 
...
Next, select an appropriate unit of measure. This unit needs to express the amount of human effort applied to this toil.
